...
//يتم استخدام المتغيرين لتمريرها الى داله تحديث الحالة
            ...
            Expanded(
              child: ElevatedButton(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                      color: completed_exrsis == counter_exrsise
                          ? Colors.green
                          : Colors.red,
                      fontWeight: FontWeight.bold,
                      fontSize: 18),
                              ...
                              Expanded(
                                ...
                                child: Column(children: [
                                  ElevatedButton(
                                      ...
                                      onPressed: () {
                                        setState(() {
                                          db_fun.delet_exsrsis(
                                              plan_list[index].name.toString());
                                      

                                          plan_list[index].explane_state =
                                              false;
                                  ...
                                  ElevatedButton(
                                      ...
                                      style: ElevatedButton.styleFrom(
                                        primary: plan_list[index].explane_state
                                            ? Colors.green
                                            : const Color.fromARGB(255, 233,
                                                231, 228), // تغيير لون الزر
                                      ),
                                      onPressed: () {
                                        setState(() {
                                          plan_list[index].explane_state =
                                           ...
                                           fun2.update_plan_state(plan_list[index].explane_state, plan_list[index].name);
                                           exe.update_exsrsie_state( plan_list[index].explane_state);
                                      })
                                ]),
                              )
                            ])));
