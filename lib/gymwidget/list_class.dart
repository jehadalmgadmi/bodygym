...
item(main_image:'assets/image/v_up.gif', name: 'v_up', count: '20 X2',
 explane: "رفع وخفض الجسم على التواي وهادا التمرين يعمل على عضلات الصدر والكتفين والظهر والساقين",
  image1: "assets/image/leg.jpg", image2: "assets/image/six_back.jpg", explane_state: false)
,
item(main_image:'assets/image/pull_up.gif', name: 'pull_up', count: '16 X2',
 explane: "رفع وخفض الجسم على التواي وهادا التمرين يعمل على عضلات الصدر والكتفين والظهر والساقين",
  image1: "assets/image/leg.jpg", image2: "assets/image/six_back.jpg", explane_state: false)
,

item(main_image:'assets/image/squats.gif', name: 'squats', count: '20 X3',
 explane: "رفع وخفض الجسم على التواي وهادا التمرين يعمل على عضلات الصدر والكتفين والظهر والساقين",
  image1: "assets/image/leg.jpg", image2: "assets/image/six_back.jpg", explane_state: false)
,
item(main_image:'assets/image/bicycle_crunches.gif', name: 'bicycle_crunches', count: '35 X1',
 explane: "رفع وخفض الجسم على التواي وهادا التمرين يعمل على عضلات الصدر والكتفين والظهر والساقين",
  image1: "assets/image/leg.jpg", image2: "assets/image/six_back.jpg", explane_state: false)
,
item(main_image:'assets/image/abdominal.gif', name: 'abdominal', count: ' 40 X2',
 explane: "وضع ساق واحدة الى الامام مع ثني الركبة واصابع القدم على الارض بينما يتم وضع الساق الاخرى الى الخلف",
  image1: "assets/image/six_back.jpg", image2: "assets/image/back.jpg", explane_state: false)
,
item(main_image:'assets/image/alternating_lunge.gif', name: 'alternating_lunge', count: ' 30 X1',
 explane: "في وضع الرقود على الظهر ومع اليدين خلف الراس نرجع الجزء العلوي من الجسم من على الارض الى الاعلى بقدر الامكان ونعود ببطء الى وضع الرقود",
  image1: "assets/image/leg.jpg", image2: "assets/image/back.jpg", explane_state: false)
,
];
...
item(main_image:'assets/image/back_pull.gif', name: 'Back pull', count: '17 X2',
 explane: "تبث الركب على الارض واجلس بشكل مستقيم ثم قم بسحب الوزن الى الخلف حتى تصل يديك الى خفل راسك ثم قم برد الوزن ودراعيك بشكل مستقيم",
  image1: "assets/image/back.jpg", image2: "assets/image/arm.jpg", explane_state: false)
,
...
item(main_image:'assets/image/back_fly.gif', name: 'Back fly', count: '30 X1',
 explane: "اجلس على مقعد الجهاز وقم بضغط مرفقيك الى المام والخلف مع الالتزام بالشهيق والزفير",
  image1: "assets/image/arm.jpg", image2: "assets/image/back.jpg", explane_state: false)
,
item(main_image:'assets/image/pull_down_bar.gif', name: 'Pull down bar', count: '20 X2',
 explane: "اجلس في مواجهه الاله واسند ركبيك على الوسادة خد شهيقا واسحب الوزن الى الاسفل ثم ارجع مرفقيك مرة اخرى",
  image1: "assets/image/back.jpg", image2: "assets/image/bay.jpg", explane_state: false)
,

item(main_image:'assets/image/dumbblee_lunge.gif', name: 'Dumbblee lunge', count: '24 X1',
 explane: "قف مع المباعدة بين قدميك على عرض الوسط وارفع ثقلا خفيفا الى اعلى الكتفين  خد شهيقا وخد خطوة مريحة الى الامام مع ابقاء الجدع في وضع مستقيم",
  image1: "assets/image/leg.jpg", image2: "assets/image/leg.jpg", explane_state: false)
,
item(main_image:'assets/image/squatting.gif', name: 'Squatting', count: '10 X2',
